...
经试验，采用不同的 _squareSize_ 并不会影响 _Intrinsic Matrix_. 最后运行都到的axis camera的参数为

{% highlight bash %}
Focal length (pixels):   [ 1220.6734 +/- 2.2370     1219.8055 +/- 2.0510  ]
Principal point (pixels):[  640.4975 +/- 3.3121      378.1767 +/- 1.8477  ]
Radial distortion:       [   -0.2890 +/- 0.0030        0.1154 +/- 0.0121  ]
{% endhighlight %}
