...
int main()
{
	...
	try {
		...
		C& rc2 = dynamic_cast<C&>(* paa); // error: dynamic type of pa2 is not C or its derived class
...
2. `lock_guard`
3. `unique_lock`
4. `conditonal_variable`
5. `future`
6. [`yield()`](https://en.cppreference.com/w/cpp/thread/yield)
